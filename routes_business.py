...
Build #158: Allows travel agencies to sign up on the consumer OTA, pay $49/mo,
get reduced fees (25% of savings vs 35%), and manage their account from a
B2B dashboard. Bridges to ANASTASiA SDK for full API access.
...
<div style="max-width:800px;margin:40px auto;padding:0 20px;">
    ...
    <div style="margin-top:50px;padding:24px;background:rgba(255,255,255,0.03);border-radius:12px;
        ...
        <table style="width:100%;color:#b0a89a;font-size:0.9rem;border-collapse:collapse;">
            ...
            <tbody>
                <tr><td style="padding:6px 0;">Starter</td><td>0+</td><td>25%</td></tr>
                <tr><td style="padding:6px 0;">Professional</td><td>50+</td><td>20%</td></tr>
                <tr><td style="padding:6px 0;">Enterprise</td><td>500+</td><td>17%</td></tr>
                <tr><td style="padding:6px 0;">Partner</td><td>5,000+</td><td>15%</td></tr>
            </tbody>
        </table>
    ...
    <div style="margin-top:30px;padding:20px;background:rgba(67,97,238,0.05);border-radius:12px;
        ...
        <p style="color:#b0a89a;font-size:0.9rem;">
            ANASTASiA SDK provides white-label flight search, AI booking agents,
            and multi-POS arbitrage via API. Starting at $99/mo.
        </p>
        <a href="https://anastasia-api.onrender.com/signup"
           target="_blank"
           style="color:#4361ee;font-size:0.9rem;text-decoration:underline;">
            Learn more about ANASTASiA SDK &rarr;
        </a>
    </div>
</div>
"""
