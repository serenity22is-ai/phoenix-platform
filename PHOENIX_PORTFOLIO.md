# PHOENIX: Flight Price Arbitrage Platform
...
The following is the complete source code for the PHOENIX platform. This code represents several thousand lines of Python, implementing the hybrid search architecture, proxy management, web scraping, database models, and business logic.

---

### A.1 main.py - Core Search Engine (1,881 lines)

The heart of PHOENIX. Contains the hybrid search orchestration, SerpAPI integration, currency conversion, deal calculation, and XRPL payment generation.
...
| **Total** | **~4,259** | Complete PHOENIX backend |

---

*Document generated: January 2026*
*PHOENIX v2.0 - Production MVP*
