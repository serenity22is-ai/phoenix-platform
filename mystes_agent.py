"""
MYSTES AI Agent Orchestrator

The brain of Mystes. MystesAI decides WHAT to search, WHERE to search,
and HOW to interpret results — without human decision-making.

Architecture:
    MystesAI reads its own intelligence data (via intelligence routes/tools),
    ...
    3. Agent mode (THIS) — MystesAI makes autonomous decisions

    The agent doesn't "learn" via LLM training. Mystes's database IS the memory.
...
Usage:
    ...
    opportunities = mystes_agent.discover_opportunities()

    # Agent decides which markets to search for a route
    markets = mystes_agent.select_markets("JFK", "NRT")
"""
...
class AgentTools:
    """
    Wraps MystesIntelligence methods as callable agent tools.
    ...
    def intelligence(self):
        if self._intelligence is None:
            try:
                ...
                logger.error("mystes_intelligence not available")
...
# ============================================================
# MystesAI Agent — the brain
# ============================================================

class MystesAgent:
    """
    The autonomous intelligence layer of Mystes.
    ...
    def handle_search(self, query: str, user_id: int = None,
        ...
        """
        Agent-orchestrated search. MystesAI decides:
    ...
    def _parse_query_intent(self, query: str, default_type: str = "flight_search") -> Dict[str, Any]:
        ...
        if "origin" not in intent:
            try:
                from mystes_intelligence import MystesIntelligence
                city_map = MystesIntelligence.CITY_AIRPORT_MAP
    ...
    def discover_opportunities(self, force: bool = False) -> Dict[str, Any]:
        ...
        MystesAI reads its own telemetry and finds new patterns.
        ...
        logger.info("MystesAI: Starting opportunity discovery...")
        opportunities = []
        ...
        logger.info(f"MystesAI: Discovered {len(opportunities)} opportunities")
