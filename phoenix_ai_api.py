"""
Phoenix AI Chat API Routes (Build #72)

Registers Flask routes for the Phoenix AI conversational interface.
Handles chat sessions, conversation management, tier info, and pricing.

Usage:
    from phoenix_ai_api import register_phoenix_ai_routes
    register_phoenix_ai_routes(app)
"""
...
def register_phoenix_ai_routes(app, csrf=None):
    """Register Phoenix AI chat API endpoints on the Flask app."""
    ...
    def ai_chat():
        """Send a message to Phoenix AI and receive a response.
        ...
        from phoenix_ai import (
            phoenix_ai, check_ai_quota, check_ai_rate_limit,
    ...
    def ai_tier_info():
        ...
        from phoenix_ai import get_ai_tier_info
    ...
    def ai_pricing():
        ...
        """
        from phoenix_ai import get_all_ai_tiers
