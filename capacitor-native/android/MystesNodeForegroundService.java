/**
 * MYSTES Node Foreground Service (Build #91)
 *
 * Android foreground service that keeps the Mystes node client alive
 ...
 *   android/app/src/main/java/com/mystes/app/MystesNodeForegroundService.java
 *
 * Required AndroidManifest.xml additions (see SETUP section below).
 */

package com.mystes.app;
...
public class MystesNodeForegroundService extends Service {

    private static final String CHANNEL_ID = "mystes_node_channel";
    private static final String CHANNEL_NAME = "Mystes Node Service";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("Mystes Node Active")
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Keeps the Mystes node running in the background");
 ...
 *
 *    <service
 *        android:name=".MystesNodeForegroundService"
